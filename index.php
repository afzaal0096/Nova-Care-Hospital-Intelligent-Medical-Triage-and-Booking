...
// FETCH FAVORITES LIST (To show red heart if logged in)
$fav_ids = [];
if ($user_id) {
            ...
            <div class="search-box">
                <form action="index.php" method="GET">
                    <div class="row g-2">
                        ...
                        <div class="col-md-3"><button type="submit" name="btn_search" class="btn btn-search"><i class="fas fa-search me-2"></i> Search</button></div>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                if (!empty($doctors_list)) {
                    foreach ($doctors_list as $doc) {
                        ...
                        if (!empty($doc['image']) && file_exists("patient/" . $doc['image'])) { $img_src = "patient/" . $doc['image']; } // Changed path logic for index.php
